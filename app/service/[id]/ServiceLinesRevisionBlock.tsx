  ...
  return (
    <>
      <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
        <h2 className="mb-3 text-sm font-medium text-stone-500">Lignes du ticket (révision)</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-stone-200 text-left">
                <th className="pb-2 pr-2 font-medium text-stone-600">#</th>
                <th className="pb-2 pr-2 font-medium text-stone-600">Nom brut</th>
                <th className="pb-2 pr-2 font-medium text-stone-600">Normalisé</th>
                <th className="pb-2 pr-2 font-medium text-stone-600">Qté</th>
                <th className="pb-2 pr-2 font-medium text-stone-600">Statut</th>
                <th className="pb-2 pr-2 font-medium text-stone-600">Plat associé</th>
                <th className="pb-2 font-medium text-stone-600">Actions</th>
              </tr>
            </thead>
            <tbody>
      ...
      <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
        <h2 className="mb-2 text-sm font-medium text-stone-500">Prévisualisation des ventes</h2>
        ...
        {preview.length === 0 ? (
          <p className="text-sm text-stone-500">Aucune ligne à enregistrer (associez des lignes à des plats).</p>
        ) : (
