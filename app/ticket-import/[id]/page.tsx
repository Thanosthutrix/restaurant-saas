    ...
    <div className="min-h-screen bg-stone-50">
      <div className="mx-auto max-w-4xl px-4 py-6">
        ...
        <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
          <h2 className="mb-3 text-sm font-medium text-stone-500">Résumé</h2>
          <ul className="grid gap-2 text-sm sm:grid-cols-2 lg:grid-cols-6">
            <li><span className="text-stone-500">Lignes</span> : {summary.total_lines}</li>
            <li><span className="text-stone-500">Reconnues</span> : {summary.recognized_count}</li>
            <li><span className="text-stone-500">Non reconnues</span> : {summary.unrecognized_count}</li>
            <li><span className="text-stone-500">Ignorées</span> : {summary.ignored_count}</li>
            <li><span className="text-stone-500">Plats sans recette</span> : {summary.dishes_missing_count}</li>
            <li><span className="text-stone-500">Plats en brouillon</span> : {summary.dishes_draft_count}</li>
          </ul>
        </section>

        {/* Infos import */}
        <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
          <h2 className="mb-2 text-sm font-medium text-stone-500">Import</h2>
        ...
        {ticketImport.image_url && (
          <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
            <h2 className="mb-2 text-sm font-medium text-stone-500">Image du ticket</h2>
        ...
        {(dishesWithMissing.length > 0 || dishesWithDraft.length > 0) && (
          <section className="mb-6 rounded-lg border border-stone-200 bg-white p-4">
            <h2 className="mb-2 text-sm font-medium text-stone-500">Statut des recettes (plats matchés)</h2>
